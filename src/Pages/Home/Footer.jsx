  ...
  return (
    ...
    <footer className="footer--container">
      ...
      <div className="footer--link--container">
        ...
        <div>
          <img src={logoa} alt="Logoipsum" height="50px" width="120px"/>
        </div>
        ...
        <div className="footer--social--icon">
          <ul>
            <li>
              <a
                href="https://mail.google.com/mail/u/0/#search/adtechagency1111%40gmail.com?compose=new"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
               <img src="https://freelogopng.com/images/all_img/1657906383gmail-icon-png.png" alt="mail-id" style={{heigh:"32px", width:"32px"}}/>
              </a>
            </li>

            <li>
              <a
                href="https://instagram.com/ad_tech_advertisement_agency?igshid=MzRlODBiNWFlZA=="
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                ...
                rel="noreferrer"
              >
               <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/WhatsApp.svg/479px-WhatsApp.svg.png" alt="github img" style={{heigh:"32px", width:"32px"}}/>
              </a>
            </li>

            <li>
              <a
                href="https://www.linkedin.com/in/adtech-advertising-agency-891206257"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer--content--container">
        <p className="footer--content">adtechagency1111@gmail.com  </p>
        <div className="footer--social--icon">
          <ul>
            <li>
              <Link
